...
import * as AssetsAPI from "./video/assets.js";
import * as LiveStreamsAPI from "./video/live-streams.js";
import * as UploadsAPI from "./video/uploads.js";
export declare class Webhooks extends APIResource {
    /**
     * Validates that the given payload was sent by Mux and parses the payload
     */
    unwrap(body: string, headers: HeadersLike, secret?: string | undefined | null): UnwrapWebhookEvent;
    private parseHeader;
...
export declare namespace BaseWebhookEvent {
    interface Attempt {
        /**
...
export declare namespace VideoDeliveryHighTrafficWebhookEvent {
    interface Data {
        id?: string;
