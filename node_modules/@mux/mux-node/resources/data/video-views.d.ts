...
export declare class VideoViews extends APIResource {
    /**
     ...
     */
    list(query?: VideoViewListParams, options?: Core.RequestOptions): Core.PagePromise<AbridgedVideoViewsBasePage, AbridgedVideoView>;
    list(options?: Core.RequestOptions): Core.PagePromise<AbridgedVideoViewsBasePage, AbridgedVideoView>;
}
export declare class AbridgedVideoViewsBasePage extends BasePage<AbridgedVideoView> {
}
...
export declare namespace VideoViewResponse {
    interface Data {
        id: string;
...
export declare namespace VideoViews {
    export { type AbridgedVideoView as AbridgedVideoView, type VideoViewResponse as VideoViewResponse, AbridgedVideoViewsBasePage as AbridgedVideoViewsBasePage, type VideoViewListParams as VideoViewListParams, };
}
