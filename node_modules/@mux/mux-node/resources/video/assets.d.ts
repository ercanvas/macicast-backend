...
export declare class Assets extends APIResource {
     ...
     */
    createPlaybackId(assetId: string, body: AssetCreatePlaybackIDParams, options?: Core.RequestOptions): Core.APIPromise<Shared.PlaybackID>;
    /**
     * Adds an asset track (for example, subtitles, or an alternate audio track) to an
     * asset.
     */
    createTrack(assetId: string, body: AssetCreateTrackParams, options?: Core.RequestOptions): Core.APIPromise<Track>;
    /**
     ...
     */
    deletePlaybackId(assetId: string, playbackId: string, options?: Core.RequestOptions): Core.APIPromise<void>;
    /**
     ...
     */
    generateSubtitles(assetId: string, trackId: string, body: AssetGenerateSubtitlesParams, options?: Core.RequestOptions): Core.APIPromise<AssetGenerateSubtitlesResponse>;
    /**
     ...
     */
    retrieveInputInfo(assetId: string, options?: Core.RequestOptions): Core.APIPromise<AssetRetrieveInputInfoResponse>;
    /**
     * Retrieves information about the specified playback ID.
     */
    retrievePlaybackId(assetId: string, playbackId: string, options?: Core.RequestOptions): Core.APIPromise<Shared.PlaybackID>;
    /**
     ...
     */
    updateMasterAccess(assetId: string, body: AssetUpdateMasterAccessParams, options?: Core.RequestOptions): Core.APIPromise<Asset>;
    /**
     ...
     */
    updateMP4Support(assetId: string, body: AssetUpdateMP4SupportParams, options?: Core.RequestOptions): Core.APIPromise<Asset>;
}
export declare class AssetsBasePage extends BasePage<Asset> {
}
...
export declare namespace Asset {
     ...
     * assume the input qualifies as standard.
     */
    interface NonStandardInputReasons {
        /**
...
export declare namespace AssetOptions {
...
export declare namespace InputInfo {
    interface File {
...
export declare namespace AssetCreateParams {
    /**
     * An array of objects that each describe an input file to be used to create the
     * asset. As a shortcut, `input` can also be a string URL for a file when only one
     * input file is used. See `input[].url` for requirements.
...
export declare namespace AssetUpdateParams {
    /**
     * Customer provided metadata about this asset.
     *
     * Note: This metadata may be publicly available via the video player. Do not
...
export declare namespace AssetGenerateSubtitlesParams {
    interface GeneratedSubtitle {
        /**
         * The language to generate subtitles in.
         */
