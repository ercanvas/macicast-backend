...
export declare class LiveStreams extends APIResource {
    /**
     ...
     * stream requests.
     */
    update(liveStreamId: string, body: LiveStreamUpdateParams, options?: Core.RequestOptions): Core.APIPromise<LiveStream>;
    /**
     * Lists the live streams that currently exist in the current environment.
     */
    list(query?: LiveStreamListParams, options?: Core.RequestOptions): Core.PagePromise<LiveStreamsBasePage, LiveStream>;
     ...
     */
    createPlaybackId(liveStreamId: string, body: LiveStreamCreatePlaybackIDParams, options?: Core.RequestOptions): Core.APIPromise<Shared.PlaybackID>;
    /**
     ...
     */
    createSimulcastTarget(liveStreamId: string, body: LiveStreamCreateSimulcastTargetParams, options?: Core.RequestOptions): Core.APIPromise<SimulcastTarget>;
    /**
     ...
     */
    deletePlaybackId(liveStreamId: string, playbackId: string, options?: Core.RequestOptions): Core.APIPromise<void>;
    /**
     ...
     */
    deleteSimulcastTarget(liveStreamId: string, simulcastTargetId: string, options?: Core.RequestOptions): Core.APIPromise<void>;
    /**
     ...
     */
    retrievePlaybackId(liveStreamId: string, playbackId: string, options?: Core.RequestOptions): Core.APIPromise<Shared.PlaybackID>;
    /**
     ...
     */
    retrieveSimulcastTarget(liveStreamId: string, simulcastTargetId: string, options?: Core.RequestOptions): Core.APIPromise<SimulcastTarget>;
    /**
     ...
     */
    updateEmbeddedSubtitles(liveStreamId: string, body: LiveStreamUpdateEmbeddedSubtitlesParams, options?: Core.RequestOptions): Core.APIPromise<LiveStream>;
    /**
     ...
     */
    updateGeneratedSubtitles(liveStreamId: string, body: LiveStreamUpdateGeneratedSubtitlesParams, options?: Core.RequestOptions): Core.APIPromise<LiveStream>;
}
export declare class LiveStreamsBasePage extends BasePage<LiveStream> {
}
...
export declare namespace LiveStream {
...
export declare namespace LiveStreamCreateParams {
...
export declare namespace LiveStreamUpdateParams {
    /**
     * Updates the new asset settings to use to generate a new asset for this live
     * stream. Only the `mp4_support`, `master_access`, and `video_quality` settings
     * may be updated.
...
export declare namespace LiveStreamUpdateEmbeddedSubtitlesParams {
    interface EmbeddedSubtitle {
        /**
         * CEA-608 caption channel to read data from.
         */
...
export declare namespace LiveStreamUpdateGeneratedSubtitlesParams {
    interface GeneratedSubtitle {
        /**
         * The language to generate subtitles in.
         */
