...
import { PageWithTotal, type PageWithTotalParams } from "../../pagination.js";
export declare class DeliveryUsage extends APIResource {
    /**
     * Returns a list of delivery usage records and their associated Asset IDs or Live
     * Stream IDs.
     */
    list(query?: DeliveryUsageListParams, options?: Core.RequestOptions): Core.PagePromise<DeliveryReportsPageWithTotal, DeliveryReport>;
    list(options?: Core.RequestOptions): Core.PagePromise<DeliveryReportsPageWithTotal, DeliveryReport>;
}
export declare class DeliveryReportsPageWithTotal extends PageWithTotal<DeliveryReport> {
}
...
export declare namespace DeliveryReport {
    /**
     * Seconds delivered broken into resolution tiers. Each tier will only be displayed
     * if there was content delivered in the tier.
     */
...
export declare namespace DeliveryUsage {
    export { type DeliveryReport as DeliveryReport, DeliveryReportsPageWithTotal as DeliveryReportsPageWithTotal, type DeliveryUsageListParams as DeliveryUsageListParams, };
}
//# sourceMappingURL=delivery-usage.d.ts.map